...
def load_img_name(img, path_folder, n_row = 20, n_columns = 20):
    '''
    ...
    n_row [int = 20] : number of rows in the combined image 
    n_columns [int = 20] : number of columns in the combined image 
    '''
...
def load_img_index(selected_index, df, path_folder, n_row = 20, n_columns = 20):
    '''
